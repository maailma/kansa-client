  ...
  renderHeader() {
    ...
    return email ? (
      ...
      <h1 className="h1-logo">
        <a href="https://conzealand.nz" class="h1-logo--link"><img src="https://maailma.github.io/kansa-client/conzealand/img/conzealand-logo.svg" alt="CoNZealand" class="img-responsive" /></a>
